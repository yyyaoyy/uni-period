...
from FR.face_recognize import recognize
...
ap.add_argument("-p", "--prototxt", required=False, default=r'mobilenet_ssd/MobileNetSSD_deploy.prototxt',
	help="path to Caffe 'deploy' prototxt file")
ap.add_argument("-m", "--model", required=False, default=r'mobilenet_ssd/MobileNetSSD_deploy.caffemodel',
		...
		# to determine direction
			...
			if not to.counted:
				...
				if direction < 0 and centroid[0] < W // 2:
					...
					if name_person not in ['Face Not Detected']:
